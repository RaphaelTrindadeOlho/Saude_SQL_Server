...
CREATE TABLE PACIENTE (
    ...
    CONSTRAINT UK_PACIENTE_PES_INT_ID UNIQUE (PES_INT_ID),
    CONSTRAINT FK_PACIENTE_PESSOA FOREIGN KEY (PES_INT_ID) REFERENCES PESSOA(PES_INT_ID)
);
...
CREATE TABLE DOUTOR (
    ...
    PES_INT_ID INT,
    CONSTRAINT PK_DOU_ID PRIMARY KEY (DOU_INT_ID),
    CONSTRAINT UK_DOUTOR_CRM UNIQUE (DOU_STR_CRM),
    CONSTRAINT UK_DOUTOR_PES_INT_ID UNIQUE (PES_INT_ID),
    CONSTRAINT FK_DOUTOR_PESSOA FOREIGN KEY (PES_INT_ID) REFERENCES PESSOA(PES_INT_ID)
);
...
CREATE TABLE CONSULTA (
    ...
    PAC_INT_ID INT,
    DOU_INT_ID INT,
    CONSTRAINT PK_CON_ID PRIMARY KEY (CON_INT_ID),
